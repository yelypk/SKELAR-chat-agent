"""Add plaintext dialogue view for quick validation.

Revision ID: 0003_add_dialogue_text_view
Revises: 0002_add_support_seniority
...
revision = "0003_add_dialogue_text_view"
down_revision = "0002_add_support_seniority"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.execute("DROP VIEW IF EXISTS dialogue_plaintext_view")
